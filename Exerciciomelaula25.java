...
Scanner ler = new Scanner (System.in); //ler as instrucoes
int numero1; // incluir variaveis inteiras

if(numero1=1) //se algo for ...
{
   System.out.print("Voce pode estacionar na vaga especial!");
   numero1=ler.nextInt;
}
else if (numero1=2) //se nao se
{
   System.out.print ("Voce pode estacionar na vaga especial!");
   numero1=ler.nextInt;
}
else if (numero1=3) //se nao se
{
    System.out.print ("Voce pode estacionar na vaga especial!");
    numero1=ler.nextInt;
}
else if (numero1=4) // se nao  se
{
